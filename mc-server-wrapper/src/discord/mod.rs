                        ...
                        match command {
                            ...
                            Command { name: "start", .. } => {
                                ...
                                if self.admin_id_list.contains(&msg.author.id) {
                                    ...
                                    if *lock {
                                        self.clone().send_channel_msg(String::from("El server está en modo restringido y no se puede abrir a través de Discord"));
                                    } else {
                                        info!("Starting the Minecraft server");
                                        self.clone().send_channel_msg(String::from("Abriendo server.."));
                            ...
                            Command { name: "stop", .. } => {
                                ...
                                if self.admin_id_list.contains(&msg.author.id) {
                                    ...
                                    self.clone().send_channel_msg(String::from("Cerrando el server..."));
